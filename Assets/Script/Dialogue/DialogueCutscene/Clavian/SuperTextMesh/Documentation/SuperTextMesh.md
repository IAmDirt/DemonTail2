...
<br>
Super Text Mesh Documentation - v1.8.2
...
NOTE: You can also use SDF shaders on normal fonts! They'll render sharp, but not as precisely as converted fonts when observed close-up. Give it a try!
